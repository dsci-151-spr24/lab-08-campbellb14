...
```
***Yes, the distribution is skewed to the left. Students on average rate courses higher on average, as the median is 4.3. This is what I expected to see because students often don't put much effort into course evaluations and may just give a average-higher score out of laziness.***
...
```
***On average, the higher the beauty average rating, the higher the average professor evaluation.***
...
evals %>%
  ...
  xlab("Beauty Average Rating") +
    ...
    ggtitle("Scatter Plot of Average Beauty Rating to Average Evaluation Score")
```
***The initial scatterplot makes the points seem much more dispersed and inconsistent. This scatterplot is less organized, but much more precise as it shows exactly where the points are on the graph.***
